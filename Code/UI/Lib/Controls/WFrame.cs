...
namespace Merculia.UI.Controls
{
	...
	{
		private WPanel m_pFormPanel;
		private System.Windows.Forms.Splitter splitter1;
		private WPanel ControlPane;
		private WPanel TopPane;
		private WPanel ToolBarPanel;
		...
		//	}
			...
			// Resize form
			if(m_Form != null){
				m_Form.Size = new Size(m_pFormPanel.ClientSize.Width - 2,m_pFormPanel.ClientSize.Height - 2);
			}
		}
		...
		public Control Frame_ToolBar
		{
			...
			set{
				...
				if(value != null){					
                    ...
                    m_TooBar.Location = new Point(0,1);
