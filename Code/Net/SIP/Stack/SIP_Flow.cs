...
using Merculia.Net.UDP;
using Merculia.Net.SIP.Message;

namespace Merculia.Net.SIP.Stack
{
    /// <summary>
        ...
        {   
            try{
                ...
                // We have SIP message header.
                    ...
                    string contentLengthValue = Merculia.Net.MIME.MIME_Utils.ParseHeaderField("Content-Length:",m_pMessage);
