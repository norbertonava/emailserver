...
namespace Merculia.Net.Mime
{
	...
	/// </summary>
    [Obsolete("See Merculia.Net.MIME or Merculia.Net.Mail namepaces for replacement.")]
	public class MailboxAddress :  Address
	{
		...
		/// For example, "Ivar Lumi" &lt;ivar@Merculia.ee&gt;.
		...
		/// <summary>
		/// Gets or sets email address. For example ivar@Merculia.ee.
		/// </summary>
		...
		/// <summary>
		/// Gets local-part from email address. For example mailbox is "ivar" from "ivar@Merculia.ee".
		/// </summary>
		...
		/// <summary>
		/// Gets domain from email address. For example domain is "Merculia.ee" from "ivar@Merculia.ee".
		/// </summary>
