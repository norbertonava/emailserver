...
namespace Merculia.Net.SMTP.Client
{
    ...
    /// // you can use Merculia.Net.Mail classes to compose valid SMTP mail message.
    /// 
    ...
    public class SMTP_Client : TCP_Client
    {
                ...
                try{
                    /* RFC 5321 4.1.1.2. MAIL
			           ...
			           RFC 1870 adds optional SIZE keyword support.
			 	        ...
			 	        Examples:
			 		        MAIL FROM:<ivx@Merculia.ee> SIZE=1000
        ...
        public static void QuickSend(Merculia.Net.Mime.Mime message)
        {
            if(message == null){
