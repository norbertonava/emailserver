...
namespace Merculia.Net.SMTP.Server
{
    /// <summary>
...
// REMOVE ME:
        ...
        private byte[] CreateReceivedHeader()
        {
            ...
            */
            ...
            Merculia.Net.Mail.Mail_h_Received received = new Merculia.Net.Mail.Mail_h_Received(this.EhloHost,Net_Utils.GetLocalHostName(this.LocalHostName),DateTime.Now);
            received.From_TcpInfo = new Merculia.Net.Mail.Mail_t_TcpInfo(this.RemoteEndPoint.Address,null);
            received.Via = "TCP";
