...
namespace Merculia.Net.RTP
{
    ...
    public class RTP_MultimediaSession : IDisposable
    {
        ...
        /// Default constructor.
        /// </summary>
        /// <param name="cname">Canonical name of participant. <seealso cref="Merculia.Net.RTP.RTP_Utils.GenerateCNAME"/>RTP_Utils.GenerateCNAME 
