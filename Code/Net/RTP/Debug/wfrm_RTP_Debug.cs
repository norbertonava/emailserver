...
using Merculia.Net;
using Merculia.Net.Media.Codec;
using Merculia.Net.RTP;

namespace Merculia.Net.RTP.Debug
{
    /// <summary>
    ...
    public class wfrm_RTP_Debug : Form
    {
        ...
        public wfrm_RTP_Debug(RTP_MultimediaSession session)
        {
            ...
            m_pSession.Error += new EventHandler<Merculia.Net.ExceptionEventArgs>(m_pSession_Error);
            m_pSession.SessionCreated += new EventHandler<Merculia.Net.EventArgs<RTP_Session>>(m_pSession_SessionCreated);
        ...
        private void m_pSession_Error(object sender,Merculia.Net.ExceptionEventArgs e)
        {
            if(m_IsDisposed){
                return;
            }
