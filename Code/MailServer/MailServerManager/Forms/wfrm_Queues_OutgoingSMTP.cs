...
{
    /// <summary>
    /// Queues Outgoing SMTP queues window.
    /// </summary>
    public class wfrm_Queues_OutgoingSMTP : Form
    {
        ...
        public wfrm_Queues_OutgoingSMTP(VirtualServer virtualServer)
        {
        ...
        private void m_pGet_Click(object sender, EventArgs e)
        {
            ...
            m_pVirtualServer.Queues.Relay.Refresh();

            foreach(QueueItem item in m_pVirtualServer.Queues.Relay){
