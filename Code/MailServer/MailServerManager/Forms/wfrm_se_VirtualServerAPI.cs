...
{
    /// <summary>
    /// Virtual server API selector window.
    /// </summary>
    public class wfrm_se_VirtualServerAPI : Form
    {
        ...
        private void InitUI()
        {
            ...
            this.Text = "Select Virtual Server API";
            ...
            m_pList.Columns.Add("Assembly",150);
            m_pList.Columns.Add("Type",200);
        ...
        #region method LoadAPIs

        /// <summary>
        /// Gets available virtual server APIs and sets them to UI.
        /// </summary>
        private void LoadAPIs()
        {
            DataSet ds = m_pServer.VirtualServers.GetVirtualServerAPIs();
            foreach(DataRow dr in ds.Tables["API"].Rows){
