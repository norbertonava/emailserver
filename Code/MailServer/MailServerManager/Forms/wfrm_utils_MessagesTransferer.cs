...
namespace Merculia.MailServer.UI
{
    ...
    {     
        ...
        private void InitUI()
        {
            ...
            m_pSource_Type.Items.Add("Merculia Mail Server User");
            ...
            m_pDestination_Type.Items.Add("Merculia Mail Server User");
        ...
        {
            #region Merculia Mail Server User
