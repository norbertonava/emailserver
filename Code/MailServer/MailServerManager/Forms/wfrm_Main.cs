...
namespace Merculia.MailServer.UI
{
    ...
    public class wfrm_Main : Form
    {
        ...
        private void InitUI()
        {
            ...
            this.Text = "Merculia Mail Server Manager";
        ...
        private void help_Forum_Click(object sender, EventArgs e)
        {
            if(Environment.OSVersion.Platform != PlatformID.Unix){
                System.Diagnostics.Process.Start("explorer","http://www.Merculia.ee/Forum");
            }
            else{
                // TODO: Make this works with default browser
                try{
                    System.Diagnostics.Process.Start("firefox","http://www.Merculia.ee/Forum");
                }
                catch{
                }
            }
