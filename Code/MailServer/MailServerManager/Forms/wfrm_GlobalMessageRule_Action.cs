...
{
    /// <summary>
    /// Global message rule action Add/Edit window.
    /// </summary>
    public class wfrm_GlobalMessageRule_Action : Form
    {        
        //--- Common UI ------------------------
        ...
        private GlobalMessageRuleActionBase m_pActionData = null;
        ...
        private void m_Ok_Click(object sender, EventArgs e)
        {
            ...
            #region SendErrorToClient
                ...
                if(!Merculia.Net.Net_Utils.IsAscii(m_pSendErrorToClient_ErrorText.Text)){
