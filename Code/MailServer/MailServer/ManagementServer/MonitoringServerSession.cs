                    ...
                    if(virtualServer.ID.ToLower() == args[0].ToLower()){
                        ...
                        foreach(string contact in args[2].Split('\t')){
                            if(contact.Length > 0){
                                ...
                                c.Parse(new Merculia.Net.StringReader(contact));
                                contacts.Add(c);
                            }
                        }
                ...
                foreach(VirtualServer virtualServer in this.Server.MailServer.VirtualServers){
                    if(virtualServer.ID.ToLower() == args[0].ToLower()){
                        ...
                        try{
                            ...
                            if(t.GetInterface("Merculia.MailServer.ISmtpMessageFilter") != null){
                                type = "ISmtpMessageFilter";
                            }
                            else if(t.GetInterface("Merculia.MailServer.ISmtpSenderFilter") != null){
                                type = "ISmtpSenderFilter";
                            }
                            else if(t.GetInterface("Merculia.MailServer.ISmtpUserMessageFilter") != null){
