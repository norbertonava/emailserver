...
namespace Merculia.MailServer
{
    ...
    {        
        ...
        public static void CheckMatchExpressionSyntax(string matchExpression)
        {
            ...
            p.Match(true,new Merculia.Net.StringReader(matchExpression),null,null,null,null,0);
        }
        ...
        {
            Merculia.Net.StringReader r = new Merculia.Net.StringReader(matchExpression);
        ...
        /// <param name="messageSize">Message size in bytes.</param>
        /// <returns>Returns true if message matches to specified criteria.</returns>
        private bool Match(bool syntaxCheckOnly,Merculia.Net.StringReader r,string mailFrom,string[] rcptTo,SMTP_Session smtpSession,Mail_Message mime,int messageSize)
        {             
            ...
            */
            ...
            while(r.Available > 0){
                ...
                // () Groupped matchers
                if(r.StartsWith("(")){
                    lastMatchValue = Match(syntaxCheckOnly,new Merculia.Net.StringReader(r.ReadParenthesized()),mailFrom,rcptTo,smtpSession,mime,messageSize);
