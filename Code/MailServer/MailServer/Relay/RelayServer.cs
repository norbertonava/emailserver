...
{
    /// <summary>
    /// This class implements relay server in Merculia Mail Server.
    /// </summary>
        ...
        private void ProcessRelay()
        {
            ...
            while(this.IsRunning){
                try{
                            ...
                            foreach(string message in messages){
                                ...
                                try{
                                    ...
                                    // Relay message info file missing.
                                        ...
                                        Merculia.MailServer.Error.DumpError(m_pVirtualServer.Name,new Exception("Relay message '" + message + "' .info file is missing, deleting message."));
                                        File.Delete(message);
                                    }                                    
                                }
                                catch(IOException x){
                    ...
                    Merculia.MailServer.Error.DumpError(m_pVirtualServer.Name,x);
                }                
            }
        }
