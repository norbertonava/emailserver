...
{
    /// <summary>
    /// The GlobalMessageRuleAction_StoreToDiskFolder object represents global message rule "Store To Disk Folder" action in Merculia Mail Server virtual server.
    /// </summary>
