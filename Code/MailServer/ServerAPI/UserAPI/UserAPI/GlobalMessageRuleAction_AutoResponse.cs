...
{
    /// <summary>
    /// The GlobalMessageRuleAction_AutoResponse object represents global message rule "Auto Response" action in Merculia Mail Server virtual server.
    /// </summary>
    public class GlobalMessageRuleAction_AutoResponse : GlobalMessageRuleActionBase
    {
        ...
        /// You can use Merculia.Net.Mime class to parse and to construct valid message.
        /// </summary>
        public byte[] Message
        {
