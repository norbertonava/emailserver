...
{
    /// <summary>
    /// The RecycleBin object represents recycle bin in Merculia Mail Server virtual server.
    /// </summary>
        ...
        private void Bind()
        {
            ...
            */
            ...
            if(ds.Tables.Contains("RecycleBinSettings")){
                m_deleteToRecycleBin  = ds.Tables["RecycleBinSettings"].Rows[0]["DeleteToRecycleBin"].Equals("1");
