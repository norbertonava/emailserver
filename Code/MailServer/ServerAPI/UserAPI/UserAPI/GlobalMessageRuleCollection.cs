...
{
    /// <summary>
    /// The GlobalMessageRuleCollection object represents global message rules in Merculia Mail Server virtual server.
    /// </summary>
                ...
                if(ds.Tables.Contains("GlobalMessageRules")){
                    foreach(DataRow dr in ds.Tables["GlobalMessageRules"].Rows){
                        m_pGlobalMessageRules.Add(new GlobalMessageRule(
                            ...
                            dr["Enabled"].ToString().Equals("1") || dr["Enabled"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase),
