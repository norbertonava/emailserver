...
namespace Merculia.MailServer.API.UserAPI
{
    /// <summary>
    /// The System_Settings object represents System settings in Merculia Mail Server virtual server.
    /// </summary>
    public class System_Settings
    {
        ...
        internal void LoadSettings(DataSet dsSettings)
        {
            ...
            m_pSMTP.Enabled                     = dr["SMTP_Enabled"].ToString().Equals("1") || dr["SMTP_Enabled"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase);
            ...
            m_pSMTP.RequireAuthentication       = dr["SMTP_RequireAuth"].ToString().Equals("1") || dr["SMTP_RequireAuth"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase);
            ...
            m_pPOP3.Enabled                 = dr["POP3_Enabled"].ToString().Equals("1") || dr["POP3_Enabled"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase);
            ...
            m_pIMAP.Enabled                 = dr["IMAP_Enabled"].ToString().Equals("1") || dr["IMAP_Enabled"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase);
            ...
            m_pRelay.StoreUndeliveredMessages    = dr["StoreUndeliveredMessages"].ToString().Equals("1") || dr["StoreUndeliveredMessages"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase);
            m_pRelay.UseTlsIfPossible            = dr["Relay_UseTlsIfPossible"].ToString().Equals("1") || dr["Relay_UseTlsIfPossible"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase);
            m_pRelay.Binds                       = relayBinds;
            
            //--- Fetch messages ------------------------------//
            m_pFetchMessages.Enabled       = dr["FetchPOP3_Enabled"].ToString().Equals("1") || dr["FetchPOP3_Enabled"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase);
            m_pFetchMessages.FetchInterval = Convert.ToInt32(dr["FetchPOP3_Interval"]);

            //--- SIP ----------------------------------------//
            m_pSIP.Enabled        = dr["SIP_Enabled"].ToString().Equals("1") || dr["SIP_Enabled"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase);
            m_pSIP.ProxyMode      = (Merculia.Net.SIP.Proxy.SIP_ProxyMode)Enum.Parse(typeof(Merculia.Net.SIP.Proxy.SIP_ProxyMode),dr["SIP_ProxyMode"].ToString());
        ...
        private void Bind()
        {
            ...
            */
            ...
            m_pSMTP = new SMTP_Settings(
                this,
                dr["SMTP_Enabled"].ToString().Equals("1") || dr["SMTP_Enabled"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase),
                ...
                dr["SMTP_RequireAuth"].ToString().Equals("1")|| dr["SMTP_RequireAuth"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase),
                smtpBinds
            );            
            //--- POP3 ------------------------------------------//
            // Get bindings
            ...
            m_pPOP3 = new POP3_Settings(
                this,
                dr["POP3_Enabled"].ToString().Equals("1") || dr["POP3_Enabled"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase),
            ...
            m_pIMAP = new IMAP_Settings(
                this,
                dr["IMAP_Enabled"].ToString().Equals("1") || dr["IMAP_Enabled"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase),
            ...
            m_pRelay = new Relay_Settings(
                ...
                dr["StoreUndeliveredMessages"].ToString().Equals("1") || dr["StoreUndeliveredMessages"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase),
                dr["Relay_UseTlsIfPossible"].ToString().Equals("1") || dr["Relay_UseTlsIfPossible"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase),
                relayBinds
            );
            //--- Fetch messages ------------------------------//
            m_pFetchMessages = new FetchMessages_Settings(
                this,
                dr["FetchPOP3_Enabled"].ToString().Equals("1") || dr["FetchPOP3_Enabled"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase),
            ...
            m_pSIP = new SIP_Settings(
                this,                
                dr["SIP_Enabled"].ToString().Equals("1") || dr["SIP_Enabled"].ToString().Equals("true", StringComparison.InvariantCultureIgnoreCase),
                (Merculia.Net.SIP.Proxy.SIP_ProxyMode)Enum.Parse(typeof(Merculia.Net.SIP.Proxy.SIP_ProxyMode),dr["SIP_ProxyMode"].ToString()),
