...
{
    /// <summary>
    /// The UserMessageRuleAction_PostToNntpNewsgroup object represents user message rule "Post To NNTP Newsgroup" action in Merculia Mail Server virtual server.
    /// </summary>
