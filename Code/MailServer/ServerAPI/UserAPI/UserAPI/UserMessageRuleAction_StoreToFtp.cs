...
{
    /// <summary>
    /// The UserMessageRuleAction_StoreToFtp object represents user message rule "Store To FTP Folder" action in Merculia Mail Server virtual server.
    /// </summary>
    public class UserMessageRuleAction_StoreToFtp : UserMessageRuleActionBase
    {
        ...
        internal UserMessageRuleAction_StoreToFtp(UserMessageRule rule,UserMessageRuleActionCollection owner,string id,string description,string host,int port,string userName,string password,string folder) : base(UserMessageRuleAction_enum.StoreToFTPFolder,rule,owner,id,description)
        {
            m_Server   = host;
            m_Port     = port;
            m_UserName = userName;
